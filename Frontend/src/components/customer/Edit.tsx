...
class EditCustomer extends React.Component<RouteComponentProps<any>, IFormState> {
    ...
    public componentDidMount(): void {
        axios.get(`http://localhost:8084/customers/${this.state.id}`).then(data => {
    ...
    private processFormSubmission = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        axios.patch(`http://localhost:8084/customers/${this.state.id}`, this.state.values).then(data => {
                            ...
                            <div className={"col-md-12 form-wrapper"}>
                                ...
                                <form id={"create-post-form"} onSubmit={this.processFormSubmission} noValidate={true}>
                                    <div className="form-group col-md-12">
                                        <label htmlFor="first_name"> Account No. </label>
                                    ...
                                    <div className="form-group col-md-12">
                                        <label htmlFor="last_name"> customer no. </label>
                                    ...
                                    <div className="form-group col-md-12">
                                        <label htmlFor="phone"> branch id </label>
                                    ...
                                    <div className="form-group col-md-12">
                                        <label htmlFor="description"> opening date </label>
                                    ...
                                    <Link to={'/displaycustomer'}><button className="btn btn-success" type="submit">
                                            Edit Customer </button></Link>
                                        {loading &&
